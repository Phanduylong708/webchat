...
import { callEndReasonMessages } from "@/features/call/types/call.type";
...
import { PrivateCallLayout } from "@/features/call/pages/Private";
import { GroupCallLayout } from "@/features/call/pages/Group";
import type { User } from "@/types/chat.type";
import type { ConversationType, CallParticipant, CallStatus } from "@/features/call/types/call.type";
import type { WbAck } from "@/features/whiteboard/types/whiteboard.type";
import { RTCProvider } from "@/features/call/providers/rtc/rtcProvider";
...
interface CallStageProps {
  ...
  stageTiles: import("@/features/call/components/StageLayout").StageLayoutTile[];
  remoteUser: User | null;
  participants: CallParticipant[];
  currentUserId: number | null;
  status: CallStatus;
